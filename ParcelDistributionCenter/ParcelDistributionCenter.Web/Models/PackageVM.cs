...
namespace ParcelDistributionCenter.Web.Models
{
    ...
    {
        public PackageVM(int packageNumber, Status status, string courierId, string senderName, string recipientName, PackageSize size, string senderEmail, string senderPhone,
